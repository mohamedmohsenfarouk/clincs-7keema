                ...
                <?php if (empty($this->session->user_id)) { ?>
                        ...
                        <div class="frame-container">
                            ...
                            <div class="row frame-content">
                                <div class="col">
                                    ...
                                    <div class="form-group eyes-section">
                                        <label for="one_eye">One Eye</label>
                                        <input type="radio" name="eyes" id="one_eye" value="One Eye" checked style="margin-right:75px;">
                                        ...
                                        <div class="col" id="provider-div">
                                            <?php foreach ($available_providers as $provider) { ?>
                                                <div class="form-group provider-card">
                                                    ...
                                                    <input type="radio" name="select-provider" data-name="<?php echo $provider['first_name'] ?>" value="<?php echo $provider['id'] ?>" id="select-provider-<?php echo $provider['id'] ?>" style="margin:8px;float:left;" checked>
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <h5 class="card-title">
                    ...
                    <div id="wizard-frame-3" class="wizard-frame" style="display:none;">
                        ...
                        <div class="command-buttons">
                            ...
                            <button type="button" id="button-next-3" class="btn button-next btn-dark" style="display: none;" data-step_index="3">
                                <?= lang('next') ?>
                                <i class="fas fa-chevron-right ml-2"></i>
                            </button>
                        </div>
                            ...
                            <div class="row frame-content">
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="first_name" id="first_name" class="form-control" value="<?php echo $user_customer_query->result()[0]->first_name; ?>" />
                                    </div>

                                    <div class="form-group">
                                        <label>Last Name</label>
                                        <input type="text" name="last_name" id="last_name" class="form-control" value="<?php echo $user_customer_query->result()[0]->last_name; ?>" />
                                    </div>
                                    <div class="form-group">
                                        <label>Email Address</label>
                                        <input type="text" name="user_email" id="email" class="form-control" value="<?php echo $user_customer_query->result()[0]->email; ?>" />
                                    </div>

                                    <div class="form-group">
                                        <label>Phone Number</label>
                                        <input type="number" name="phone_number" id="phone_number" class="form-control" value="<?php echo $user_customer_query->result()[0]->phone_number; ?>" />
                                    </div>
                                </div>
