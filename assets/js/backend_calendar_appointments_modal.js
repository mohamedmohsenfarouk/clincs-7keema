    ...
    function bindEventHandlers() {
        ...
        $("#manage-appointment #save-appointment").on("click", function() {
            ...
            var appointment = {
                ...
                id_branches: $dialog.find("#select-branch").val(),
        ...
        $("#insert-appointment").on("click", function() {
            ...
            if (
                $("#select-filter-item option:selected").attr("type") === "provider"
            ) {
                ...
                $("#select-filter-item option:selected").attr("type") === "service"
            ) {
                $dialog
                    .find(
            ...
            $dialog
                .find("#start-datetime")
                .val(
                    GeneralFunctions.formatDate(start, GlobalVariables.dateFormat, true)
                );
            $dialog
                .find("#end-datetime")
                .val(
                ...
                $.post(url, data)
                    .done(function(response) {
                        ...
                        response.forEach(function(customer) {
                            ...
                            var result = GlobalVariables.customers.filter(function(
                                globalVariablesCustomer
                            ) {
                                return (
                                    Number(globalVariablesCustomer.id) === Number(customer.id)
                                );
                            });
        ...
        /**
         * Event: Selected branch "Change"
         *
         * When the user clicks on a branch, its available providers should become visible. Also we need to
         * update the start and end time of the appointment.
         */
        $("#select-branch").on("change", function() {
            ...
            $(".provider-section").css("display", "block");
