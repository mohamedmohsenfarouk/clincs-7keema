        ...
        if (
            ...
            $html = $("<div/>", {
                html: [
                    ...
                    GeneralFunctions.renderMapIcon(event.data.branch),
                    $("<span/>", {
                        text: event.data.branch.name,
                    }),
                    $("<br/>"),
                    ...
                    $("<span/>", {
                        text: event.data.provider.first_name +
                            " " +
                            event.data.provider.last_name,
                    }),
                    $("<br/>"),
                    ...
                    $("<span/>", {
                        ...
                        text: event.data.customer.first_name +
                            " " +
                        ...
                        case "agendaDay":
                            ...
                            if (workingPlanExceptions && workingPlanExceptions[weekdayDate]) {
                                ...
                                workingPlanExceptionEnd =
                                    weekdayDate + " " + sortedWorkingPlan[weekdayName].end;
                            ...
                            viewStart = moment(
                                calendarView.start.format("YYYY-MM-DD") + " 00:00:00"
                            );
                            ...
                            viewEnd = moment(
                                calendarView.end.format("YYYY-MM-DD") + " 00:00:00"
                            );
                            ...
                            sortedWorkingPlan[weekdayName].breaks.forEach(function(
                                breakPeriod
                            ) {
                                ...
                                sortedWorkingPlan[weekdayName].breaks.forEach(function(
                                    ...
                                    var unavailabilityEvent = {
                                        ...
                                        start: moment(
                                            ...
                                            calendarDate.format("YYYY-MM-DD") + " " + breakPeriod.end
                                        ),
                                        allDay: false,
                                        color: "#BEBEBE",
                                        editable: false,
    ...
    exports.initialize = function() {
            ...
            select: function(start, end) {
                ...
                if (
                    ...
                    service = GlobalVariables.availableServices.find(function(service) {
                        return (
                            Number(service.id) === Number($("#select-filter-item").val())
                        );
                    });
                    ...
                    var provider = GlobalVariables.availableProviders.find(function(
                        ...
                        return (
                            Number(provider.id) === Number($("#select-filter-item").val())
                        );
                    });
        ...
        if (GlobalVariables.availableProviders.length > 0) {
            $("<optgroup/>", {
                ...
                html: GlobalVariables.availableProviders.map(function(
                    ...
                    var hasGoogleSync =
                        availableProvider.settings.google_sync === "1" ? "true" : "false";
                    all_app.push(availableProvider.id);
                    return $("<option/>", {
        ...
        if (GlobalVariables.availableServices.length > 0) {
            $("<optgroup/>", {
                ...
                html: GlobalVariables.availableServices.map(function(
                    ...
                    all_app.push(availableService.id);
                    return $("<option/>", {
        ...
        if (GlobalVariables.user.role_slug === Backend.DB_SLUG_SECRETARY) {
            ...
            $('#select-filter-item option[type="provider"]').each(function(
                ...
                var provider = GlobalVariables.secretaryProviders.find(function(
                    secretaryProviderId
                ) {
