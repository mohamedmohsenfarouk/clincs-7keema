...
(function() {
    ...
    ProvidersHelper.prototype.bindEventHandlers = function() {
        ...
        $('#providers').on('click', '#add-provider', function() {
            ...
            $('#branches-services input:checkbox').prop('disabled', false);
    ...
    ProvidersHelper.prototype.resetForm = function() {
        ...
        $('#branches-services input:checkbox')
            .prop('disabled', true)
            .prop('checked', false);
    ...
    ProvidersHelper.prototype.display = function(provider) {
        ...
        $('#branches-services input:checkbox').prop('checked', false);
        ...
        provider.branches.forEach(function(branchServiceId) {
            var $checkbox = $('#branches-services input[data-id="' + branchServiceId + '"]');
